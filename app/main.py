...
from app.views import home, assessment, results, about, sample_cases, statistics, technical
...
def main():
    ...
    page = st.sidebar.radio(
        "Navigation",
        ["🏠 Home", "📈 Statistics", "🔧 Technical", "📋 New Assessment", "🧪 Sample Cases", "📊 Results", "ℹ️ About"],
        index=0,
    )
